package net.sanberdir.lessen.world.feature;
...
public class ExampleTreeFeature extends Feature<NoFeatureConfig> {
    ...
    private static final BlockState LOG = InitBlocks.BROWN_LOG.get().getDefaultState();
    private static final BlockState LEAVES = InitBlocks.BROWN_LEAVES.get().getDefaultState().with(LeavesBlock.DISTANCE, 2);
